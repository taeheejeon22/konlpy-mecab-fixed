...
- A 2 eojeol string '영치기 영차' which is incorrectly morpheme-tokenized as one morpheme (영치기 영차/IC) is forced to morpheme-tokenized as two morpheme temporarily.
